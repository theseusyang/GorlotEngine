...
function TreeElement(container)
{
	...
	this.arrow.setImage("src/editor/files/icons/misc/arrow_down.png");
	...
	this.element.oncontextmenu = function(event)
	{
		if(self.obj !== null)
		{
			...
			{
				// Add Blocks
				menu.addOption("Add Blocks", () => {
					//self.obj.add(new BlockScript(undefined, self.obj.uuid))
					var blocks = new BlockScript(undefined, self.obj.uuid)

					if (self.obj instanceof THREE.Light) {
						blocks.blocks_type = "light"
					} else if (self.obj instanceof THREE.Camera) {
						blocks.blocks_type = "camera"
					} else if (self.obj instanceof PhysicsObject) {
						blocks.blocks_type = "physics"
					}
...
TreeElement.prototype.setObject = function(obj)
{
	...
	if(obj.folded)
	{
		this.arrow.setImage("src/editor/files/icons/misc/arrow_right.png");
	}
}
...
TreeElement.prototype.addFromObject = function(obj)
{
	...
	if(element.folded)
	{
		element.arrow.setImage("src/editor/files/icons/misc/arrow_right.png");
	}
